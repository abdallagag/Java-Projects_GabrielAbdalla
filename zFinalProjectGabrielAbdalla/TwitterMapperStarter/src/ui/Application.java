    ...
    public Application() {
        ...
        map().addMouseMotionListener(new MouseAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                map().setToolTipText("Zoom Here");
                List<MapMarker> mapMarkers = getMarkersCovering(pos, pixelWidth(p));
                if (!mapMarkers.isEmpty()) {
                    String text = "<html>";
                    for (MapMarker marker : mapMarkers) {
                        MapMarkerCustom markerCustom = (MapMarkerCustom) marker;
                        text += "<p><img src=" + markerCustom.getProfileImage() + ">";
                        text += markerCustom.getTweetText() + "</p>";
                    }
                    text += "</html>";
